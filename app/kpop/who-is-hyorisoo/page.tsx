        ...
        <div className="mx-auto flex w-full max-w-6xl flex-col gap-10 px-6 py-6 md:px-8 md:py-8">
          ...
          <section className="rounded-[2rem] border border-[var(--border)] bg-[var(--card)] p-6 md:p-8">
            <div className="space-y-7 text-base leading-8 text-[var(--muted)] md:text-lg">
              ...
              <p>
                ...
                Girls&apos; Generation continues separately as the full
                group; HYORISOO, officially credited as Girls&apos;
                Generation-HRS, is a three-member unit featuring Hyoyeon,
                Yuri, and Sooyoung.
              </p>
              ...
              <p>
                ...
                roles like main vocal and center, half as a joke. HYORISOO
                grew from Hyo&apos;s Level Up content into an official unit
                project.
              </p>
          ...
          <section className="rounded-[2rem] border border-[var(--border)] bg-[var(--surface)] p-6 md:p-8">
            ...
            <h2 className="mt-3 text-3xl font-semibold">
              HYORISOO &mdash; &quot;Skibidi&quot; Performance Video
            </h2>

            <p className="mt-5 max-w-3xl text-base leading-8 text-[var(--muted)]">
              Official performance video from SMTOWN, SM Entertainment&apos;s
              YouTube channel.
            </p>
            ...
            <div className="mt-6">
              <YouTubeEmbed
                ...
                title="Girls' Generation-HRS 소녀시대-효리수 'Skibidi' Performance Video"
              />
            </div>

            <a
              href="https://www.youtube.com/watch?v=oAwzFFEYm38"
              target="_blank"
              rel="noreferrer"
